...
public class Bag implements Iterable<Object>
{
    ...
    {
        // this represents the Bag object, we called Iterator on
    ...
    private static class BagIterator implements Iterator<Object>
    {
        ...
        {
            //ensure that the data hasn't change while we are iterating
            if(parentBag.modCount != currentModCount)
            {
                throw new ConcurrentModificationException("You cannot change a bag while iterating over it!");
            }
